  ...
  return (
	...
	"
      ...
      <g>
        <path
          style={{ fill: '#C7CFE2' }}
          d="M203.034,211.862c-2.259,0-4.518-0.862-6.241-2.586L90.862,103.345
        ...
        <path
          style={{ fill: '#C7CFE2' }}
          d="M414.897,423.724c-2.259,0-4.518-0.862-6.241-2.586L302.724,315.207
        ...
        <path
          style={{ fill: '#C7CFE2' }}
          d="M308.966,211.862c-2.259,0-4.518-0.862-6.241-2.586c-3.448-3.448-3.448-9.035,0-12.483
        ...
        <path
          style={{ fill: '#C7CFE2' }}
          d="M97.103,423.724c-2.259,0-4.518-0.862-6.241-2.586c-3.448-3.448-3.448-9.035,0-12.483
